...
public static class AudioFileValidator {
    ...
    public static readonly List<string> SupportedAudioFormats = [
        ...
        ".PSF", ".PSF1", ".PSF2", ".MINIPSF", ".MINIPSF1", ".MINIPSF2", ".SSF", ".MINISSF", ".GSF", ".MINIGSF", ".QSF",
        ".MINIQSF",
    ...
    public static Dictionary<ExtendAudioFormats, string> AudioFormatsExtendToNameMap { get; } =
        new() { [ExtendAudioFormats.Ncm] = ".NCM" };

    private static bool IsAudioFile(string filePath) { return File.Exists(filePath) && ValidateWithMetadata(filePath); }
