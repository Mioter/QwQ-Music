...
public partial class SoundEffectConfigModel : ObservableObject
{
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Stereo Enhancement", new EffectConfig
        {
    ...
    private bool _isEnabledMultiChannelReplayGainEffect = true;
    public bool IsEnabledMultiChannelReplayGainEffect
    {
        get => _isEnabledMultiChannelReplayGainEffect;
        set
        {
            if (SetProperty(ref _isEnabledMultiChannelReplayGainEffect, value))
            {
                UpdateMultiChannelReplayGainEffectConfig();
            }
        }
    }
    
    
    private void UpdateMultiChannelReplayGainEffectConfig()
    {
        _audioPlay?.UpdateSpecificEffects("Multi-Channel Replay Gain", new EffectConfig
        {
            Enabled = IsEnabledMultiChannelReplayGainEffect,
        });
    }
    ...
    private double _fadeInMilliseconds = 1000;
    ...
    private double _fadeOutMilliseconds = 1000;
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Fade", new EffectConfig
        {
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Reverb", new EffectConfig
        {
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Compressor", new EffectConfig
        {
            Enabled = IsEnableCompressorEffect,
        });
    }
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Echoes", new EffectConfig
        {
            Enabled = IsEnableEchoesEffect,
        });
    }
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Distortion", new EffectConfig
        {
            Enabled = IsEnableDistortionEffect,
        });
    }
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Tremolo", new EffectConfig
        {
            Enabled = IsEnableTremoloEffect,
        });
    }
    ...
    private void UpdateEqualizerEffectConfig()
    {
        ...
        _audioPlay?.UpdateSpecificEffects("Equalizer", new EffectConfig
        {
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Rotating", new EffectConfig
        {
    ...
    {
        _audioPlay?.UpdateSpecificEffects("Spatial", new EffectConfig
        {
